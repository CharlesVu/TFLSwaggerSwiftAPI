//
// JourneyPlannerRouteOption.swift
//
...
public struct JourneyPlannerRouteOption: Codable {
    ...
    public init(_id: String?, name: String?, directions: [String]?, lineIdentifier: Identifier?) {
        self._id = _id
        self.name = name
