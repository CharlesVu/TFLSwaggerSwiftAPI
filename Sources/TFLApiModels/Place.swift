...
public struct Place: Codable {
    ...
    public init(_id: String?, url: String?, commonName: String?, distance: Double?, placeType: String?, additionalProperties: [AdditionalProperties]?, children: [Place]?, childrenUrls: [String]?, lat: Double?, lon: Double?) {
        self._id = _id
        self.url = url
