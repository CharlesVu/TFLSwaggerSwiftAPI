...
public struct Disruption: Codable {
    ...
    public init(category: Category?, type: String?, categoryDescription: String?, _description: String?, summary: String?, additionalInfo: String?, created: Date?, lastUpdate: Date?, affectedRoutes: [RouteSection]?, affectedStops: [StopPoint]?, closureText: String?) {
