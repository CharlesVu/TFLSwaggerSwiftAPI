...
class Decoders {
    ...
    private static var __once: () = {
        ...
        // Decoder for [CacheSettings]
        Decoders.addDecoder(clazz: [CacheSettings].self) { (source: AnyObject) -> [CacheSettings] in
            return Decoders.decode(clazz: [CacheSettings].self, source: source)
        }
        // Decoder for CacheSettings
        Decoders.addDecoder(clazz: CacheSettings.self) { (source: AnyObject) -> CacheSettings in
            let sourceDictionary = source as! [AnyHashable: Any]

            let instance = CacheSettings()
            instance.cacheName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["cacheName"] as AnyObject?)
            instance.maxItemTtlSecondsOverride = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["maxItemTtlSecondsOverride"] as AnyObject?)
            instance.settingsTtlSecondsOverride = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["settingsTtlSecondsOverride"] as AnyObject?)
            instance.lastInvalidated = Decoders.decodeOptional(clazz: Date.self, source: sourceDictionary["lastInvalidated"] as AnyObject?)
            instance.modifiedDate = Decoders.decodeOptional(clazz: Date.self, source: sourceDictionary["modifiedDate"] as AnyObject?)
            return instance
        }
        ...
        // Decoder for [NotificationEvent]
        Decoders.addDecoder(clazz: [NotificationEvent].self) { (source: AnyObject) -> [NotificationEvent] in
            return Decoders.decode(clazz: [NotificationEvent].self, source: source)
        }
        // Decoder for NotificationEvent
        Decoders.addDecoder(clazz: NotificationEvent.self) { (source: AnyObject) -> NotificationEvent in
            let sourceDictionary = source as! [AnyHashable: Any]

            let instance = NotificationEvent()
            instance.eventName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["eventName"] as AnyObject?)
            instance.notificationParameters = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["notificationParameters"] as AnyObject?)
            return instance
        }


        // Decoder for [NotificationSubscription]
        Decoders.addDecoder(clazz: [NotificationSubscription].self) { (source: AnyObject) -> [NotificationSubscription] in
            return Decoders.decode(clazz: [NotificationSubscription].self, source: source)
        }
        // Decoder for NotificationSubscription
        Decoders.addDecoder(clazz: NotificationSubscription.self) { (source: AnyObject) -> NotificationSubscription in
            let sourceDictionary = source as! [AnyHashable: Any]

            let instance = NotificationSubscription()
            instance.userName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["userName"] as AnyObject?)
            instance.eventName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["eventName"] as AnyObject?)
            instance.callbackUrl = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["callbackUrl"] as AnyObject?)
            if let callbackVerb = sourceDictionary["callbackVerb"] as? String { 
                instance.callbackVerb = NotificationSubscription.CallbackVerb(rawValue: (callbackVerb))
            }
            
            instance.useProxy = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["useProxy"] as AnyObject?)
            return instance
        }
