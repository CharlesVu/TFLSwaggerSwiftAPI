//
// TflApiPresentationEntitiesPrediction.swift
//
...
public struct TflApiPresentationEntitiesPrediction: Codable {
    ...
    public var timing: TflApiPresentationEntitiesPredictionTiming?

    public init(_id: String?, operationType: Int?, vehicleId: String?, naptanId: String?, stationName: String?, lineId: String?, lineName: String?, platformName: String?, direction: String?, bearing: String?, destinationNaptanId: String?, destinationName: String?, timestamp: Date?, timeToStation: Int?, currentLocation: String?, towards: String?, expectedArrival: Date?, timeToLive: Date?, modeName: String?, timing: TflApiPresentationEntitiesPredictionTiming?) {
        self._id = _id
