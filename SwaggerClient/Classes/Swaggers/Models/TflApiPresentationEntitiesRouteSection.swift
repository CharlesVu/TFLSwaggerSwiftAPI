//
// TflApiPresentationEntitiesRouteSection.swift
//
...
public struct TflApiPresentationEntitiesRouteSection: Codable {
    ...
    public var routeSectionNaptanEntrySequence: [TflApiPresentationEntitiesRouteSectionNaptanEntrySequence]?

    public init(_id: String?, lineId: String?, routeCode: String?, name: String?, lineString: String?, direction: String?, originationName: String?, destinationName: String?, validTo: Date?, validFrom: Date?, routeSectionNaptanEntrySequence: [TflApiPresentationEntitiesRouteSectionNaptanEntrySequence]?) {
        self._id = _id
        self.lineId = lineId
