//
// TflApiPresentationEntitiesRoadDisruption.swift
//
...
public struct TflApiPresentationEntitiesRoadDisruption: Codable {
    ...
    public var streets: [TflApiPresentationEntitiesStreet]?
    ...
    public var roadProject: TflApiPresentationEntitiesRoadProject?
    /** TDM Additional properties */
    public var publishStartDate: Date?
    public var publishEndDate: Date?
    public var timeFrame: String?
    public var roadDisruptionLines: [TflApiPresentationEntitiesRoadDisruptionLine]?
    public var roadDisruptionImpactAreas: [TflApiPresentationEntitiesRoadDisruptionImpactArea]?
    public var recurringSchedules: [TflApiPresentationEntitiesRoadDisruptionSchedule]?

    public init(_id: String?, url: String?, point: String?, severity: String?, ordinal: Int?, category: String?, subCategory: String?, comments: String?, currentUpdate: String?, currentUpdateDateTime: Date?, corridorIds: [String]?, startDateTime: Date?, endDateTime: Date?, lastModifiedTime: Date?, levelOfInterest: String?, location: String?, status: String?, geography: SystemDataSpatialDbGeography?, geometry: SystemDataSpatialDbGeography?, streets: [TflApiPresentationEntitiesStreet]?, isProvisional: Bool?, hasClosures: Bool?, linkText: String?, linkUrl: String?, roadProject: TflApiPresentationEntitiesRoadProject?, publishStartDate: Date?, publishEndDate: Date?, timeFrame: String?, roadDisruptionLines: [TflApiPresentationEntitiesRoadDisruptionLine]?, roadDisruptionImpactAreas: [TflApiPresentationEntitiesRoadDisruptionImpactArea]?, recurringSchedules: [TflApiPresentationEntitiesRoadDisruptionSchedule]?) {
        self._id = _id
        self.url = url
        self.point = point
