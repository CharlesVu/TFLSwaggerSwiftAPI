//
// TflApiPresentationEntitiesStreet.swift
//
...
public struct TflApiPresentationEntitiesStreet: Codable {
    ...
    public var segments: [TflApiPresentationEntitiesStreetSegment]?
    ...
    public init(name: String?, closure: String?, directions: String?, segments: [TflApiPresentationEntitiesStreetSegment]?, sourceSystemId: Int64?, sourceSystemKey: String?) {
        self.name = name
